...
"""
local_gcp_credential_path = Path(
    os.getcwd() + "/local-data-platform/samples/creadentials.json"
)
...
config_path = Path(
    os.getcwd()
    + "/local-data-platform/real_world_use_cases/near_data_lake/config/ingestion.json"
)
